...
class AnimationHelpers:
    ...
    @staticmethod
    def animate_container_entry(container: ft.Container, page: ft.Page, 
                              delay: float = 0.1, duration: int = AnimationPresets.SLOW):
        """
    ...
    def animate_button_click(button: ft.ElevatedButton, page: ft.Page):
        ...
        Args:
            ...
            page: Página do Flet
        """
        original_elevation = button.style.elevation.get("", 5) if button.style and button.style.elevation else 5
    ...
    @staticmethod
    def animate_progress_bar(progress_bar: ft.ProgressBar, page: ft.Page, 
                           target_value: float = 1.0, duration: float = 2.0):
        """
...
class SnackbarAnimations:
    ...
    @staticmethod
    def show_animated_snackbar(page: ft.Page, message: str, color: str = "green", 
                             duration: int = 3000, icon: Optional[ft.Icons] = None):
        """
